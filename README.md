...
`universities.json` 依据教育部公开的历史 985 / 211 工程名单口径建立基础索引，仅用于院校层级初筛。它不提供专业目录、考试科目、招生人数、复试线或参考书；其中官网链接、主管部门、双一流状态和现行招生单位信息仍需要后续逐校人工核验。详细边界见 `docs/university-index-guide.md`。
