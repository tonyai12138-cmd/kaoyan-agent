...
真题拆解模式面向经管类、市场营销、数字营销、消费者行为与品牌管理等专业课训练，支持论述题、简答题、案例分析题、材料分析题和策划题。

- 本地题型模板来自 `src/data/questionTemplates.json`，覆盖品牌社群、KOL / KOC、内容种草、私域运营、AARRR 增长、直播电商、用户画像、短视频与 AI 生成内容等高频场景。
- 命中模板后的回答固定包含题目考点、答题框架、可用理论、案例方向、常见失分点、示范开头、建议背诵结构与下一步行动。
- DeepSeek 回答与本地 mock fallback 共享相同的结构要求；没有精准模板时仍提供通用拆解框架。
- 模板仅用于学习参考和框架训练，不代表真实命题范围；具体考试要求以目标院校专业课要求为准。

专项使用说明见 `docs/question-analysis-guide.md`。
