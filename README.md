...
基础索引中的 `candidateMajorAreas` 仅表示后续可核验的经管方向候选池，不代表该校当年开设或招收对应专业。当前 `schools.json` 的专业条目均为演示样例，尚未关联到官方院校索引；官网链接、主管部门、双一流状态和现行招生单位信息也仍需后续逐校人工核验。详细边界见 `docs/university-index-guide.md`。
