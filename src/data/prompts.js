...
export const ragLexicon = {
  ...
  questionAnalysis: [
    "请分析", "如何看待", "论述", "论述题", "简述", "简答题", "案例分析",
    "材料分析", "专业课论述题", "这道题怎么答", "答题框架", "考点",
    "理论", "失分点", "示范开头", "背诵结构", "品牌社群", "私域",
    "KOL", "KOC", "AARRR", "内容种草", "直播电商", "用户画像",
    "短视频营销", "全域营销", "数据驱动营销", "AI 生成内容", "数字营销",
    "消费者忠诚", "消费者信任", "品牌资产", "用户复购",
  ],
  sourceVerification: [
...
export const promptKnowledge = [
  ...
  },
  {
    ...
    mode: "exam",
    title: "论述与案例题框架",
    keywords: ["分析", "论述", "简答", "案例", "真题", "作答", "数字营销", "AARRR", "内容种草", "私域", "KOL"],
    content: "真题拆解应按题目考点、答题框架、可用理论、案例方向、常见失分点、示范开头、建议背诵结构和下一步行动输出；命中题型模板时优先使用模板内容，案例仅作为学习方向，不虚构事实。",
    sourceType: "methodology",
    dataStatus: "demo",
  },
  {
